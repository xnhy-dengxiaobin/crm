...
export const BUSINESS_HOST = `${process.env.BUSI_HOST}/core/`;//取数
export const SSO_HOST = `${process.env.BUSI_HOST}/sso/`;//登录
export const FILE_HOST = `${process.env.BUSI_HOST}/file/`;//文件服务
export const CAPTCHA_HOST = `${process.env.BUSI_HOST}/captcha/`;//图片验证码服务
export const IMAGE_HOST = `${process.env.BUSI_HOST}/pics/`;//图片上传
export const EXCEL_HOST = `${process.env.BUSI_HOST}/excel/`;//excel导入导出
